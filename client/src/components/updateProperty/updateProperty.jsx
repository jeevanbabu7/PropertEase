...
const PropertyForm = () => {
    ...
    <section className="property-form">
        ...
        <Grid container spacing={2} sx={{
            ...
            >  
                <h1 className='h1-update'>Update property</h1>
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <FormControlLabel  required  control={<Checkbox onChange={handleChange} checked={formData.parking } id="parking"/>} label="Parking Spot" />
